...
def openai_api_request(model="gpt-4o",
                       ...
                       frequency_penalty=0,
                       logprobs=True,
                       max_completion_tokens=300):  # Add max_completion_tokens parameter
    ...
    data = {
        ...
        "max_tokens": max_completion_tokens  # Add max_tokens to the request
    }
    ...
    def thinkAbout(self, message, conversation, model=None, debug=False):
        ...
        try:
            response, prompt_tokens, completion_tokens, total_tokens, logprobs_list = openai_api_request(
                ...
                max_completion_tokens=300  # Add max_completion_tokens to the call
            )
        except:
            try:
                response, prompt_tokens, completion_tokens, total_tokens, logprobs_list = openai_api_request(
